module "vpc" {
  source = "git::https://github.com/srujanakamarsu/tf-module-vpc.git"
...
module "alb" {
  source = "git::https://github.com/srujanakamarsu/tf-module-alb.git"
...
module "docdb" {
  source = "git::https://github.com/srujanakamarsu/tf-module-docdb.git"
  tags   = var.tags
  env    = var.env
...
module "rds" {
 source = "git::https://github.com/srujanakamarsu/tf-module-rds.git"
 tags   = var.tags
 env    = var.env
...
module "elasticache" {
 source = "git::https://github.com/srujanakamarsu/tf-module-elasticache.git"
 tags   = var.tags
 env    = var.env
...
module "rabbitmq" {
  source  = "git::https://github.com/srujanakamarsu/tf-module-rabbitmq.git"
  tags    = var.tags
  env     = var.env
  zone_id = var.zone_id
...
module "app" {
  ...
  source = "git::https://github.com/srujanakamarsu/tf-module-app.git"
